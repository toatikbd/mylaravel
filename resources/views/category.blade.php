...
@section('content')
    ...
    <!-- Page Title -->
    <section class="page-title-wrap" data-bg-img="{{ url('storage/category/'. $category->image) }}" data-rjs="2">
        <div class="container">
            <div class="row">
                <div class="col">
                    ...
                    <div class="blog">
                        <div class="row isotope">
                            ...
                            @else
                                <div class="col-md-6">
                                    <div class="single-news mb-55" data-animate="fadeInUp" data-delay=".1">
                                        <h3 class="h5">Sorry, No post found! <a href="{{ route('home') }}">Go Back</a></h3>
                                    </div>
                                </div>  
                            @endif
