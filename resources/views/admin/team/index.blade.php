...
@section('content')
    <div class="container-fluid">
            <div class="block-header">
                <a href="{{ route('admin.team.create') }}" class="btn btn-primary waves-effect">
                                        ...
                                        @foreach($teams as $key => $team)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    {{-- <a href="{{ route('admin.team.show', $team->id) }}" class="btn  btn-xs btn-primary waves-effect">
                                                        <i class="material-icons">visibility</i>
                                                    </a> --}}
                                                    <a href="{{ route('admin.team.edit', $team->id) }}" class="btn  btn-xs btn-primary waves-effect">
                                                        <i class="material-icons">edit</i>
                                                    </a>
                                                    <button class="btn  btn-xs btn-danger waves-effect" type="button" onclick="delectTeam({{ $team->id }})">
