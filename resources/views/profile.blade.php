                ...
                <div class="col">
                    <div class="page-title" data-animate="fadeInUp" data-delay="1.2">
                        ...
                        <ul class="list-unstyled m-0 d-flex">
                            ...
                            <li><a href="#">Profile : {{ $author->name }}</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                    ...
                    <div class="blog">
                        <div class="row isotope">
                            ...
                            @else
                                <div class="col-md-6">
                                    <div class="single-news mb-55" data-animate="fadeInUp" data-delay=".1">
                                         <h3 class="h5">Sorry, No post found! <strong>Stay for Posts</strong></h3>   
                                    </div>
                                </div>
                            @endif
                            <!-- End of Single Post -->
                ...
                <div class="col-lg-4">
                    <aside>
                        ...
                        <div class="sidebar-widget mb-55" data-animate="fadeInUp" data-delay=".1">
                            <h3 class="bordered-title">About Author</h3>
                            <h4>Name : {{ $author->name }}</h4>
                            <p>About : {{ $author->about }}</p>
                            <p><strong>Author Since : {{ $author->created_at->toDateString() }}</strong></p>
                            <p><strong>Total Posts : {{ $author->posts->count() }}</strong></p>
                        </div>
                        <div class="sidebar-widget mb-55" data-animate="fadeInUp" data-delay=".1">
